...
export function StreamManagement() {
  ...
  const startInputStream = async (inputId: string) => {
    try {
      ...
      // Call API endpoint to start the stream
      const response = await fetch(`/api/streams/inputs/start/${inputId}`, {
        method: 'POST',
        headers: {
  ...
  const stopInputStream = async (inputId: string) => {
    try {
      ...
      // Call API endpoint to stop the stream
      const response = await fetch(`/api/streams/inputs/stop/${inputId}`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const startOutputStream = async (outputId: string) => {
    try {
      ...
      // Call API endpoint to start the stream
      const response = await fetch(`/api/streams/outputs/start/${outputId}`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const stopOutputStream = async (outputId: string) => {
    try {
      ...
      // Call API endpoint to stop the stream
      const response = await fetch(`/api/streams/outputs/stop/${outputId}`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
